...
[![Build Status](https://travis-ci.org/lesha888/hystrix-go.png?branch=master)](https://travis-ci.org/lesha888/hystrix-go)
[![GoDoc Documentation](http://godoc.org/github.com/lesha888/hystrix-go/hystrix?status.png)](https://godoc.org/github.com/lesha888/hystrix-go/hystrix)
...
For API documentation, refer to [GoDoc](https://godoc.org/github.com/lesha888/hystrix-go/hystrix)

How to use
----------

```go
import "github.com/lesha888/hystrix-go/hystrix"
```
...
- ```cd /go/src/github.com/lesha888/hystrix-go```
- ```go test ./...```
